...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=2500&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Full+Stack+Developer;Python+Developer;Backend+Developer;Problem+Solver" alt="Typing SVG"/>
...
I'm an ECE graduate passionate about **Python development and problem-solving**.  
I enjoy building practical applications and continuously improving my programming and DSA skills.
...
> 💡 I started with electronics but found my passion in software development.
...
### 🐾 Animal Footprint Classification using CNN

A deep learning project that classifies animal species from footprint images using a **Convolutional Neural Network (CNN)**.

The system uses image preprocessing and CNN-based classification to identify different animal footprints.
...
An AI-based application that analyzes resumes to extract key information such as **skills, education, and experience**.

The system evaluates resume content, identifies relevant keywords, and provides feedback to help candidates improve their resumes for specific job requirements.
...
<p align="center">
  📄 <a href="https://drive.google.com/drive/u/0/folders/1Ek5ujDSfB-B0hswTRtaclu_9ukkfFpU6">
  <b>View My Resume</b>
  </a>
</p>
